...
@section('content')
	...
	<div class="error error-5 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url({{ asset('assets/media/img/bg-1.jpg') }});">
		<!--begin::Content-->
		<div class="container d-flex flex-row-fluid flex-column justify-content-md-center p-12" style="align-items: center; margin: auto;">
			...
			<p class="font-weight-boldest display-4 color-white">cooming soon</p>
